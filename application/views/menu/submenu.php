                    ...
                    <?php foreach ($SubMenu as $sm) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                class="badge badge-danger" onclick="return confrim('yakin akan dihapus?');">
                                Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
    ...
    <div class="modal fade" id="exampleModalsubedit<?=$sm['id']; ?>" tabindex="-1" aria-labelledby="newmenumodallabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <form action="<?= base_url('menu/submenuedit/'); ?>" method="post">
                ...
                <div class="form-group">
                    <input type="hidden" class="form_control" id="id" name="id"
                ...
                <div class="form-group">
                    <input type="text" class="form_control" id="url" name="url" placeholder="SubMenu icon">
                </div>
