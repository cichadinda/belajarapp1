...
private function _sendEmail($token, $type)
{
    ...
    $config['smtp_user'] = 'cichalee05@gmail.com';//isi dgn email yg baru dibuat
    $config['smtp_pass'] = 'hilhdhdqkkganatz';
    ...
    $this->email->from('cichalee05@gmail.com', 'web Programing SMKN8Jember');
...
public function verify()
            ...
            if ($user_token) {
                if (time() - $user_token['date_created'] < (60 * 60 * 24)) {
                    ...
                    '<div class="alert alert-succes" role="alert">' .
                        $email . 'has been Active!Please Login</div>');
                    redirect('auth');
                } else {
    ...
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert-succes" role="alert">password has been change! Please login</div>');
            redirect('auth');
        }
    }
